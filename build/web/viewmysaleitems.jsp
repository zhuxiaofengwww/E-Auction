    ...
    <div id="mainboxer">
       <div class="container">
                    ...
                    <%  
                                            ...
                                            //String sqlQuery = "SELECT Item.ItemID, Item.ItemName, Item.ItemDescription, Item.AskingPrice, Item.ListingDate, Item.ExpirationDate,Item.ItemCategory, Item.PicturePath,Bid.ItemID FROM Person, Item, Bid WHERE Item.ItemID = Bid.ItemID  AND PersonId  = '" + userPersonalID + "' ORDER BY ItemID ";
                                            ...
                                            out.println("<th >Item Category</th>");
                                            out.println("<th >Item Statement</th>");                       
                                            out.println("<th >Open Listing</th>");
                    ...
                    //************************************************************************************* 
                                    ...
                                    out.println("Open");
                                        ...
                                        out.println("</td>");                           
                                                ...
                                                out.println("<td>");
                                                out.println("<a href='viewmysaleitems.jsp?BidItemID=" + rs.getString(1) + "'>");
                                                
                                                out.println("<input type = 'button' value ='Open Item' />");//delete button
                                                out.println("</a>");
                                                //out.println(rs.getString(1));
                                                out.println("</td>");
